...
@section('body')
		...
		<div class="page-banner team-banner container-fluid no-padding">
			...
			<div class="container">
				...
				<p>so beguiled and demoralized by the charms of pleasure of the moment</p>
				<ol class="breadcrumb">
					<li><a href="#">Home</a></li>
					...
					<div class="counter-app">
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="statistics-box">
								<i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-12.png')}}"></i>
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="statistics-box">						
								<i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-22.png')}}"></i>
								<div class="statistics-content">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="statistics-box">
								<i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-32.png')}}"></i>
								<div class="statistics-content">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="statistics-box">
								<i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-42.png')}}"></i>
								<div class="statistics-content">
