...
<body>
    <div class="container">
        <h1 style="text-transform: uppercase;">CÁC TIỆM THUỐC GẦN BẠN:
        <div id="product">
...
<script>
    ...
    <script>
        ...
        {
            $.ajax({
                url: "/webdatlichbacsi/site/finddoctor/store",
                type: "GET",
                dataType: 'json',
                success: function(response){
                    var my_orders = $("#product");
                                ...
                                "<div class='row'>"+
                                        "<div class='col-md-5 col-sm-12 col-xs-12'>"+
                                            "<div class='product-image'>"+
                                                "<img class='img-responsive' src='http://localhost/webdatlichbacsi/public/"+index.people.image+"'>"+
                                                "<span class='tag2 hot'>"+
                                                    "HOT"+
                                                "</span>"+
                                            "</div>"+
                                        ...
                                        "<div class='product-deatil'>"+
                                                "<h5 class='name'>"+
                                                    "<a href='javascript:void(0);'>"+
                                                        index.people.name+
                                                    "</a>"+
                                                       "<p class='price-container'>Cách khoảng: "+parseFloat(index.dist*2).toFixed(2)+" km</p>"+
                                                "</h5>"+
                                        "</div>"+

                                        "<div class='description' style='height:120px;''>"+
                                            index.people.description+
                                        "</div>"+
                                    "</div>"+
                                "</div>"+
                            "</div>"+
