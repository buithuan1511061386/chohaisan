				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12 blog-area ">			
						<article class="blog-post-list col-md-12 col-sm-12 col-xs-12">
							<div class="entry-header">
								<div class="entry-cover">
									<a href="blog-post.html"><img src="{{asset('public/frontend/images/blog-1.jpg')}}" alt="blog-1"/></a>
						...
						<article class="blog-post-list col-md-12 col-sm-12 col-xs-12">
							<div class="entry-header">
								<div class="entry-cover">
									<a href="blog-post.html"><img src="{{asset('public/frontend/images/blog-2.jpg')}}" alt="blog-2"/></a>
									<a href="blog-post.html" class="read-more"><i class="fa fa-link"></i>Read More</a>
								</div>
							</div>
							<div class="entry-content">	
						...
						<article class="blog-post-list col-md-12 col-sm-12 col-xs-12">
							<div class="entry-header">
								<div class="entry-cover">
									<a href="blog-post.html"><img src="{{asset('public/frontend/images/blog-3.jpg')}}" alt="blog-3"/></a>
									<a href="blog-post.html" class="read-more"><i class="fa fa-link"></i>Read More</a>
								</div>
							</div>
							<div class="entry-content">	
