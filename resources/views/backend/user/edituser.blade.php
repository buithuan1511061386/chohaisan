                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Edit
                                </h3>
                            ...
                            <div class="panel-body">
                                <!-- errors -->
                                <!--main content-->
                                <form id="commentForm" action="{{route('admin.user.update_post',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                                    <!-- CSRF Token -->
									{{csrf_field()}}
									   <fieldset>
                                        <!-- Name input-->
                                        <div class="form-group hidden">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="user_level_id" name="user_level_id" type="text" class="form-control" value="{{ $data->user_level_id }}"  />
                                                    </div>
                                                </div>
                                        <div class="form-group">
                                                    <label for="name" class="col-sm-2 control-label">Role *</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" value= "@if ($data->user_level_id==1)
                                                                            {{ "Admin"}}
                                                                            @elseif($data->user_level_id==2)
                                                                            {{ "Doctor"}}
                                                                            @else
                                                                            {{"User"}}
                                                                        @endif" class="form-control" disabled="disabled" />
                                                    </div>
                                                </div>
                                       <div class="form-group">
                                                    <label for="name" class="col-sm-2 control-label">Name *</label>
                                                    <div class="col-sm-10">
                                                        <input id="name" name="name" type="text" placeholder="Name" class="form-control" value="{{ $data->name }}" required />
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                    <label for="email" class="col-sm-2 control-label">Email *</label>
                                                    <div class="col-sm-10">
                                                        <input id="email" name="email" placeholder="E-mail" type="text" class="form-control required email"  value="{{ $data->email }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="birthday" name="birthday" type="text" class="form-control" data-date-format="YYYY-MM-DD" placeholder="yyyy-mm-dd" value="{{ $data->birthday }}" />
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label for="phone" class="col-sm-2 control-label">Phone *</label>
                                                    <div class="col-sm-10">
                                                        <input id="phone" name="phone" type="text" placeholder="Phone" class="form-control" required  value="{{ $data->phone}}" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                                <img src="{{asset('public/'."$data->image")}}" alt="profile pic">
                                                            </div>
                                    ...
                                    <span class="fileinput-new">Select image</span>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea name="description" id="description" class="form-control resize_vertical" rows="4">{{ $data->description}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control select21" id="sex" title="Select Gender..." name="sex">
                                                            ...
                                                            <option value="1" {{ $data->sex == 1 ? 'selected="selected"' : '' }}


                                                                >MALE</option>
                                                            <option value="0" {{ $data->sex == 0 ? 'selected="selected"' : '' }}>FEMALE </option>
                                                            <option value="2" {{ $data->sex == 2 ? 'selected="selected"' : '' }}>OTHER </option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="btnAddHospital"class="btn btn-responsive btn-primary btn-sm">Submit</button>
                                            </div>
                                        </div>
