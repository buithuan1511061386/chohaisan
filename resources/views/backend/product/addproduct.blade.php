                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Thêm sản phẩm
                                </h3>
                            ...
                            <div class="panel-body">
                                <!-- errors -->
                                <!--main content-->
                                <form id="commentForm" action="{{route('admin.product.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                                    <!-- CSRF Token -->
									{{csrf_field()}}
									   <fieldset>
                                        <!-- Name input-->
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="name" name="name" type="text" placeholder="Tên sản phẩm" class="form-control" required />
                                                    </div>
                                                </div>
												 <div class="form-group">
                                                    <label for="category_id" class="col-sm-2 control-label">Loại sản phẩm</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="amout" name="amout" type="text" placeholder="Số lượng" class="form-control"/>
                                                    </div>
                                                </div>
												                                   <div class="form-group">
