                    ...
                    <div class="panel panel-primary ">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Danh sách sản phẩm
                            </h4>
                        </div>
                            ...
                            <table class="table table-bordered " id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{ route('admin.product.show',$product->id)}}" class="btn btn-primary">View</a>
